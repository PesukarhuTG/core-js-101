...
function angleBetweenClockHands(date) {
  ...
  const min = 360 / 60;
  const hourAngle = hour * (60 * (date.getUTCHours() % 12) + date.getUTCMinutes());
  const minAngle = min * date.getUTCMinutes();
